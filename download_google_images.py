...
def get_image_urls(query:str, max_links_to_fetch:int, wd:webdriver, sleep_between_interactions:int=1):
    ...
    while image_count < max_links_to_fetch:
        ...
        for img in thumbnail_results[results_start:number_results]:
            ...
            # print("Max no of images can be downloaded is",len(image_urls))
            time.sleep(5)
...
def download_image(folder_path:str,url:str):
    ...
    try:
        ...
        file_path = os.path.join(folder_path, 'scrape_' + hashlib.sha1(image_content).hexdigest()[:10] + '.jpg')
...
def find_and_download(search_term:str,driver_path:str,target_path='./images',number_images=5):
    ...
    try:
        ...
        try:
            ...
            print("Please provide less no of images to download and Try Again!!")
...
if __name__ == "__main__":
    ...
    find_and_download(search_term ="talking to camera", \
                        driver_path = "", \
                        target_path='./webimages', \
                        number_images=10000)
